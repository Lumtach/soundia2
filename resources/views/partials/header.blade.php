<header class="site-header">
  ...
  <div class="site-header__right">
    <button class="global-audio-toggle" type="button" aria-label="Toggle audio"><span></span></button>
    <details class="language-dropdown">
      <summary aria-label="Select language"><span class="language-dropdown__globe" aria-hidden="true"></span><span class="language-dropdown__current">{{ strtoupper($locale) }}</span></summary>
    ...
    <div class="mobile-menu">
      <button class="mobile-menu__toggle" type="button" data-menu-open aria-label="Open menu"><span aria-hidden="true"></span></button>
      <div class="mobile-menu__overlay" role="dialog" aria-modal="true">
        <aside class="mobile-menu__panel">
          <div class="mobile-menu__top"><button class="mobile-menu__close" type="button" data-menu-close aria-label="Close menu"><span aria-hidden="true"></span></button></div>
          <div class="mobile-menu__content">
            <nav class="mobile-menu__nav" aria-label="Mobile navigation">
              <a href="{{ url('/') }}">{{ $locale === 'ru' ? 'Главная' : ($locale === 'lv' ? 'Sākums' : 'Home') }}</a>
